...
public class DBTable {
	...
	boolean joinCheck(String _i, String _p, String _n, String _nn, String _e) {
		...
		String pw = _p;
		String em = _e;
		System.out.println(na + nn + id + pw + em);
		try {
			//member 테이블에 각 문자열들을 순서대로 업데이트하는 문장. 승, 패는 초기값을 숫자 0으로 한다.
			String insertStr = "INSERT INTO member VALUES('" + na + "', '" + nn + "', '" + id + "', '" + pw + "', '" + em + "', 0, 0,0)";
